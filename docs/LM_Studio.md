...
> [!IMPORTANT]
> Using local small LLM e.g. `liquid/lfm2.5-1.2b` *Q8_0* as our resource is limited, so we recommend using a more powerful model for better & more accurate results.